...
export default function SectionSkills() {
  ...
  if (loading) {
    return (
      <div className="flex h-full w-full flex-col items-center overflow-y-auto px-6 pt-24 pb-44 md:pt-36 md:pb-4">
  ...
  return (
    <div className="mx-auto flex h-full max-w-7xl flex-col items-center overflow-y-auto p-6 pt-10 pb-44 scrollbar-hide md:p-20 md:pt-36 md:pb-4">
