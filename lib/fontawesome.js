...
// EXPECTATION: Font Awesome packages are installed via the project package manager (e.g. bun). We should import the "free-brands" and "free-solid" packs entirely if possible or instruct user.
